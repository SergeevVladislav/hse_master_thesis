...
%  например \begin{enumerate}[resume] позволяет продолжить нумерацию в новом списке
	...
	\begin{document} % Начала документа
		...
		\begin{center}
			\bfseries Федеральное государственное бюджетное образовательное учреждение высшего образования
		...
		\parbox[t]{20em}{\centering
			...
			заведующий кафедрой государственных и муниципальных финансов
			
			\mbox{ }
			
			\rule{8em}{0.5pt} проф. Н.П.Ефимова
			
			\mbox{ }
			
			<<\rule{2em}{0.5pt}>> \rule{5em}{0.5pt} 20\rule{1em}{0.5pt} г. }
		...
		\begin{center}\bfseries
			...
			\large
			РЕГУЛИРОВАНИЕ И ОЦЕНКА БАНКОМ РОССИИ \\
			РИСКОВ ДЕЯТЕЛЬНОСТИ СТРАХОВЫХ ОРГАНИЗАЦИЙ
		\end{center}
		...
		\noindent
		к.э.н., доцент Ларионов Александр Витальевич
		\hfill /\rule{6em}{0.5pt}/\rule{6em}{0.5pt}/
		...
		\begin{center}
			\normalsize \bfseries МОСКВА \\ 2023 г.
		\end{center}
		\endgroup
		...
		\noindent \rule{9em}{0.5pt} \hspace{1em} / Сергеев Владислав Александрович /
